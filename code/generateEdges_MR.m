...
function generateEdges_MR( G, analyzed, thresh, last_real_an)
close all

num_mut_per_gene = load('../tmp/num_alt_per_gene.sparse');
...
for z=1:1:length( thresh  )
	name_file = strcat( '../tmp/edgesLists/edgesList.txt' , int2str( indices_to_consider(z) ) );
